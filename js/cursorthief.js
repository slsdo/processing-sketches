...
void setup() {
  ...
  noCursor();
  mousecursor = loadImage("js/data/cursorthief_cursor.png");
  sweatdrop = loadImage("js/data/cursorthief_sweatdrop.png");
  heart = loadImage("js/data/cursorthief_heart.png");
  smooth();
}
