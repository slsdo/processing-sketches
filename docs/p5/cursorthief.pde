...
void setup() {
  ...
  noCursor();
  mousecursor = loadImage("p5/data/cursorthief_cursor.png");
  sweatdrop = loadImage("p5/data/cursorthief_sweatdrop.png");
  heart = loadImage("p5/data/cursorthief_heart.png");
  smooth();
...
void mouseClicked() {
  if (!renderCanvas[2]) renderCanvas[2] = true;
}
